import { Sparkles, ArrowDown, Users, Eye, Target, Heart } from 'lucide-react';
  ...
  return (
    <Section id="marca-personal" className="min-h-screen py-24">
      ...
      <div className="container relative z-10">
        ...
        <div 
          ref={elementRef}
          className={`grid lg:grid-cols-2 gap-20 items-start mb-20 transition-all duration-1000 ${
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce">
          <button 
            ...
            className="p-4 opacity-50 hover:opacity-80 transition-all duration-300 vintage-shadow"
            style={{ backgroundColor: 'rgba(86, 80, 33, 0.1)' }}
          >
            <ArrowDown className="w-6 h-6" style={{ color: '#565021' }} />
          </button>
        </div>
      </div>
    </Section>
